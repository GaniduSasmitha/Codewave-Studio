  ...
  return (
    <div className="py-20 text-center max-w-md mx-auto px-4 flex flex-col items-center justify-center min-h-[60svh]">
      ...
      <div className="mt-8 flex gap-4">
        <Link
          to="/"
          className="border border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-transparent hover:bg-slate-200 dark:hover:bg-slate-900 text-slate-800 dark:text-slate-100 px-6 py-2.5 rounded-lg text-sm font-medium transition-colors"
        >
          Go Home
        </Link>
        <Link
